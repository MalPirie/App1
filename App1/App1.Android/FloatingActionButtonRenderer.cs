...
[assembly: ExportRenderer(typeof(MyFab), typeof(MyFabRenderer))]
namespace App1.Droid
{
    public class MyFabRenderer : Xamarin.Forms.Platform.Android.AppCompat.ViewRenderer<MyFab, FloatingActionButton>
    {
        public MyFabRenderer(Context context) : base(context)
        { }

        protected override void OnElementChanged(ElementChangedEventArgs<MyFab> e)
        {
        ...
        {
            var fab = (FloatingActionButton)Control;
